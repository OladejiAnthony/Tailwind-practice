...
const Hero = () => {
  return (
    <div name='home' className='w-full h-[130vh] md:h-screen bg-zinc-200 flex flex-col justify-between'> {/*you can name the class, and also Customize your theme background-color - bg-[#50d71e] */}
        <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
            ...
            <div className='absolute flex flex-col py-8 md:min-w-[760px] bottom-[5%] md:mt-[100px]
            mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200
            border border-slate-300 rounded-xl text-center shadow-xl'>
                <p>Data Services</p>
                <div className='flex justify-between flex-wrap px-4'>
                    {/*Customize your theme text-color - text-[#50d71e] */}
